const Common = (function () {
    const initial_url = "https://gateway.marvel.com:443/v1/public/characters";
    const api_token = "1659179700434";
    const public_key = 'c49abfc194e63b7f880768eaca73a33d';
    const hash = '048cf29e8b55cad228aa2324eca6a521';

    const apiUrl = `${initial_url}?ts=${api_token}&apikey=${public_key}&hash=${hash}`;
